...
export default function GoalsPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-gradient-to-b from-background to-emerald-50/20">
      <SiteHeader currentPath="/goals" onSearchClick={() => setSearchDialogOpen(true)} />
          ...
          <div className="container px-4 sm:px-6">
            ...
            <Tabs defaultValue="daily" className="mt-8">
              ...
              <TabsContent value="daily" className="mt-6 space-y-6">
                <Card className="overflow-hidden border-2 border-emerald-100 shadow-md hover:shadow-lg transition-all w-full">
                ...
                <Card className="overflow-hidden border-2 border-emerald-100 shadow-md hover:shadow-lg transition-all w-full">
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div className="pt-4">
                      ...
                      <div className="mt-2 flex flex-wrap text-xs gap-4">
                ...
                <Card className="overflow-hidden border-2 border-emerald-100 shadow-md hover:shadow-lg transition-all w-full">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex flex-col sm:flex-row gap-2">
                      <Input placeholder="Add allergy..." className="flex-grow" />
